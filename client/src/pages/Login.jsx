    ...
    <div className="min-h-screen flex bg-slate-50">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-indigo-600 text-white flex-col justify-between p-12 relative overflow-hidden">
        ...
        <div className="relative max-w-md">
          <h2 className="text-4xl font-bold leading-tight">Generate high-converting marketing campaigns in minutes.</h2>
        ...
        <div className="w-full max-w-md bg-white p-8 rounded-2xl shadow-sm border border-slate-100">
          ...
          <form onSubmit={handleSignIn} className="mt-8 space-y-5">
            <div>
              ...
              <input
                type="email"
                defaultValue="demo@campaignstudio.com"
                required
          ...
          <p className="mt-8 text-center text-xs text-slate-500">
            ...
            <Link to="/signup" className="text-indigo-600 hover:text-indigo-700 font-semibold">Sign up for free</Link>
          </p>
        </div>
      </div>
    </div>
